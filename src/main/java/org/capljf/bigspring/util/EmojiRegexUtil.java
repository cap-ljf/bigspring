...
/**
 * emoji regex 参考： https://github.com/zly394/EmojiRegex
 * @author jifang.liu created on 2018/10/29 15:39
 */
public class EmojiRegexUtil {
    ...
    public static void main(String[] args) {
        String str = "● 1.赠送免税店8折优惠券，购物更实惠！";
        System.out.println(str.replaceAll(getFullEmojiRegex(), ""));
    }
}
